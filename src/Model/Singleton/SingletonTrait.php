 ...
 * us to do this.
 *
 * We declare a trait that can be used in many of the classes in the
 * application that should be Singletons. Classes that should only be instanced
 * once in the application should be Singletons.
 */
